      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700">Độ mờ overlay</label>
              <input
                type="range"
                min="0"
                max="1"
              ...
              />
              <span className="text-sm text-gray-500">{formData.overlayOpacity}</span>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Tiêu đề dòng 2</label>
              <input
                type="text"
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          ...
          {formData.highlightedWords.map((word, index) => (
            <div key={index} className="flex gap-2 mb-2">
              ...
              <button
                type="button"
                onClick={() => {
                  const newWords = formData.highlightedWords.filter((_, i) => i !== index);
                  setFormData(prev => ({ ...prev, highlightedWords: newWords }));
                }}
          ...
          <button
            ...
            onClick={() => {
              setFormData(prev => ({
                ...prev,
                highlightedWords: [...prev.highlightedWords, { text: '', color: '#000000' }]
              }));
            }}
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          ...
          {formData.features.map((feature, index) => (
            <div key={index} className="grid grid-cols-2 gap-2 mb-4 p-4 border rounded-md">
              <div>
                <label className="block text-xs text-gray-500">Icon (Font Awesome)</label>
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    <ul className="mt-1 grid grid-cols-2 gap-2">
                      <li><code>fa-shoe-prints</code> - 👟 Icon giày</li>
                      <li><code>fa-tag</code> - 🏷️ Icon thẻ giá</li>
                      <li><code>fa-truck</code> - 🚚 Icon vận chuyển</li>
                      <li><code>fa-box</code> - 📦 Icon hộp</li>
                      <li><code>fa-star</code> - ⭐ Icon sao</li>
                      <li><code>fa-check</code> - ✓ Icon tích</li>
                      <li><code>fa-gift</code> - 🎁 Icon quà</li>
                      <li><code>fa-heart</code> - ❤️ Icon tim</li>
                    </ul>
                    <p className="mt-1">
                      Xem thêm icon tại: <a href="https://fontawesome.com/icons" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800">Font Awesome Icons</a>
                    </p>
                  </div>
                </div>
              </div>
              <div>
                <label className="block text-xs text-gray-500">Màu nền icon</label>
                <input
                  type="color"
