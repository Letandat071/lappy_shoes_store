...
const orderTabs = [
  ...
  { id: 'processing', label: 'Đã đặt', icon: 'fas fa-clock', 
    statuses: ['pending', 'processing'] },
  { id: 'shipping', label: 'Đang vận chuyển', icon: 'fas fa-shipping-fast',
    statuses: ['shipped'] },
  { id: 'completed', label: 'Hoàn thành', icon: 'fas fa-check-circle',
    statuses: ['delivered'] },
  { id: 'cancelled', label: 'Đã hủy', icon: 'fas fa-times-circle',
    statuses: ['cancelled'] }
];
                ...
                <div className="text-center py-12 bg-white rounded-lg shadow">
                  ...
                  <p className="text-gray-500 mb-6">
                    {activeTab === 'all' 
                      ...
                      : `Bạn không có đơn hàng nào ở trạng thái ${orderTabs.find(tab => tab.id === activeTab)?.label.toLowerCase()}`
                    }
                  </p>
                  <Link
                    href="/shop"
                        ...
                        <div className="flex flex-wrap gap-6 justify-between">
                          ...
                          <div className="text-right">
                            <p className="text-sm text-gray-600 mb-1">
                              Phương thức thanh toán: {order.paymentMethod === 'COD' ? 'Thanh toán khi nhận hàng' : 'Thanh toán online'}
                            </p>
